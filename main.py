...
data = [
  ...
  },
  {
    ...
    "attributes": {
         ...
         "shortdescription": "Предположительно, разговаривает со своей катаной, которую иногда поглаживает своей правой рукой и обращается к ней по имени Юлия",
      "location":"Город Нежити",
      "health":"650",
      "soul":"50",
      "items":"-",
        "description": "Торговец не имеет связи с главным сюжетом, хотя он действительно предлагает полезные предметы для игроков в начале игры. Он также предупреждает, что неподалеку располагаются довольно опасные противники: Демон Капра, Демон-Телец и Красная Виверна.",
        "image": "https://static.wikia.nocookie.net/darksouls/images/a/a0/Нежить-торговец.png/revision/latest?cb=20130413194522&path-prefix=ru"
    }
  },
  {
    "id": "37",
    "attributes": {
        ...
        "shortdescription": "Телохранитель Реи из Торолунда.",
      "location":"Храм Огня Склеп Великанов",
      "health":"682 - Храм Огня, 970 - Склеп Великанов",
      "soul":"1000",
      "items":"Человечность x 3",
        "description": "Винс, как и Нико, были друзьями детства Реи из Торолунда. Сопровождают Рею в поисках Обряда Возжигания.",
        "image": "https://static.wikia.nocookie.net/darksouls/images/9/9f/Нико_из_Торолунда.jpg/revision/latest?cb=20131129182002&path-prefix=ru"
    }
  },
  {
    "id": "38",
    "attributes": {
         "name": "Giant Crow",
        "shortdescription": "Огромная птица, живущая в Лордране.",
      "location":"Северное Прибежище Нежити ↔ Храм Огня",
      "health":"-",
      "soul":"-",
      "items":"-",
        "description": "Огромная птица, живущая в Лордране. Она перелетает от гнезда к гнезду, перенося Избранного Немёртвого из прибежища в Храм Огня и обратно. С ней нельзя поговорить или взаимодействовать каким-либо другим способом, кроме как через места транспортировки — обрыв и гнездо.",
        "image": "https://static.wikia.nocookie.net/darksouls/images/5/5f/Огромная_Ворона_%28ХО%29.jpg/revision/latest?cb=20130706205157&path-prefix=ru"
    }
  },
  {
    "id": "39",
    "attributes": {
       ...
       "shortdescription": "Также известный как Продавец Индульгенций, Освальд — служитель богини Велки",
      "location":"Уезд Нежити",
      "health":"1200",
      "soul":"2000",
      "items":"Двойная человечность 2х Книга виновных",
        "description": "Также известный как Продавец Индульгенций, Освальд — служитель богини Велки, и поэтому имеет право разрывать соглашения с ковенантами, отпускать грехи и продавать некоторые, вероятно, священные для служителей Велки, товары за души, как и все торговцы. Несмотря на преклонные года и унылость Лордрана, при разговоре он производит впечатление веселого и довольного человека: он часто шутит, смеется. В диалогах на игрока реагирует по-разному, в зависимости от человечности и количества грехов. Также может отпускать едкие комментарии при покупке у него некоторых вещей.",
        "image": "https://static.wikia.nocookie.net/darksouls/images/0/05/Освальд_из_Карима.jpg/revision/latest?cb=20130318093124&path-prefix=ru"
    }
  },
  {
    "id": "40",
    "attributes": {
        ...
        "shortdescription": "Рыцарь из Асторы, первый дружелюбный персонаж, которого игрок встречает в Лордране.",
      "location":"Северное Прибежище Нежити",
      "health":"30",
      "soul":"100 / 1,000 3750 (NG+6)",
      "items":"Фляга с Эстусом Ключ от восточного крыла 2 этажа Большой ключ паломника Щит с эмблемой",
        "description": "Рыцарь из Асторы, первый дружелюбный персонаж, которого игрок встречает в Лордране. В его семье знали легенду об Избранном Немертвом и считали, что им станет Оскар.  Впервые протагонист видит Оскара во вступительном ролике игры, где тот скидывает в камеру героя труп с ключом от камеры. ",
        "image": "https://static.wikia.nocookie.net/darksouls/images/7/7e/Оскар_из_Асторы.jpg/revision/latest/scale-to-width-down/1000?cb=20130203195509&path-prefix=ru"
    }
  },
  {
    "id": "41",
    "attributes": {
         "name": "Paladin Leeroy",
        "shortdescription": " фантом в игре Dark Souls.",
      "location":"Склеп Великанов, Катакомбы",
      "health":"1500",
      "soul":"21,236",
      "items":"Грант Санктус Человечность 3х",
        "description": "Мало что известно об этом персонаже, так как он не разговаривает и никто о нем не говорит вообще. О нем упоминается лишь в описаниях его снаряжения. Он был первым мертвецом-паладином из ковенанта Белый Путь. Владеющий легендарными Грантом и Санктусом, он был послан в Лордран с неизвестной для нас миссией. Может быть они думали, что он Избранный мертвец, и послали его, чтобы совершить обряд возжигания или победить Нито. Так как в его помещении лежит труп в доспехах Лироя, он, скорее всего, пал от руки Лорда Нито.",
        "image": "https://static.wikia.nocookie.net/darksouls/images/b/b5/Паладин_Лирой.png/revision/latest/scale-to-width-down/1000?cb=20180530090905&path-prefix=ru"
    }
  },
  {
    "id": "42",
    "attributes": {
         ...
         "shortdescription": "Петрус — торолундский клирик, член Белого Пути и один из спутников Реи из Торолунда",
      "location":"Храм Огня",
      "health":"1500",
      "soul":"[NG] - 1,000, [NG+] - 5,000",
      "items":"Человечность x2 Костяной талисман (если он убил Рею)",
        "description": "Петрус — торолундский клирик, член Белого Пути и один из спутников Реи из Торолунда, разыскивающей в Лордране обряд Возжигания. Он первым появляется в месте сбора — Храме Огня — и вынужден ждать своих товарищей, задержавшихся в дороге. Хотя Петрус выглядит очень любезным и доброжелательным, он человек совсем не добрый и себе на уме.  Когда группа клириков спустится в Катакомбы, Петрус бросит своих попавших в ловушку и обманутых Лоскутиком спутников. Позже, если Рея будет спасена игроком, Петрус попытается убить Рею, и это ему удастся, если игрок ему не помешает.",
        "image": "https://static.wikia.nocookie.net/darksouls/images/c/c3/Петрус_из_Торолунда.jpg/revision/latest?cb=20130403211208&path-prefix=ru"
    }
  },
  {
    "id": "43",
    "attributes": {
         "name": "The Fair Lady",
         "shortdescription": "Лидер ковенанта Слуги Хаоса и сестра Квилег.",
      "location":"Владение Квилег",
      "health":"1500",
      "soul":"5,000",
      "items":"Душа Хранительницы Огня",
        "description": "Лидер ковенанта Слуги Хаоса и сестра Квилег. Ослепшая, ослабевшая и почти умершая после поглощения болезненного гноя её слуги Энги, она полностью обездвижена и является хранительницей костра рядом. Её речь вначале не ясна, но с надетым кольцом Старой ведьмы вы можете с ней нормально говорить. Она принимает вас за свою сестру, Квилег, потому что она единственная, кто навещает её и кто может с ней говорить. Энги называет её Белая Госпожа (The White Lady) или Прекрасная Госпожа (The Fair Lady).",
        "image": "https://static.wikia.nocookie.net/darksouls/images/a/a9/Прекрасная_Госпожа.jpg/revision/latest/scale-to-width-down/1000?cb=20130303145000&path-prefix=ru"
    }
  },
  {
    "id": "44",
